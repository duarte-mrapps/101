...
if [[ "$confirmacao_final" =~ ^[Ss]$ ]]; then
  ...
  if [ -f "$storyboard_file" ]; then
    sed -i '' "s/.109803921568627450/$red_srgb/g" "$storyboard_file"
    sed -i '' "s/.109803921568627450/$green_srgb/g" "$storyboard_file"
    sed -i '' "s/.109803921568627450/$blue_srgb/g" "$storyboard_file"
  fi
